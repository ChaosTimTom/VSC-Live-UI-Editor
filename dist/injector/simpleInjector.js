...
exports.injectSourceMetadata = injectSourceMetadata;
...
function injectSourceMetadata(input, workspaceRelativeFile) {
    ...
    return lines
        ...
        return lineText.replace(OPENING_TAG, (match, tagName, offset) => {
            // Avoid double-injecting if the line already contains our attrs.
            if (lineText.includes('data-source-file=') ||
